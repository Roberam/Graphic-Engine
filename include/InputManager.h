...
private:
	...
	int _mouseX;
	int _mouseY;
	Array<VirtualButton> _myVirtualButtons;
	Array<VirtualAxis> _myVirtualAxis;

	bool existsVButton (int& index, const String name) const;
	bool existsVAxis (int& index, const String name) const;
